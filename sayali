...
<head>
    ...
    <title>Sayali & Pranav | Wedding</title>
...
<body>
    ...
    <section id="story" class="section">
        ...
        <p>
            Two hearts, two lives and one beautiful journey.

            We are excited to begin this new chapter together
            and would love to celebrate our special day with
    ...
    <section id="gallery" class="section">
        ...
        <div class="gallery">
            ...
            <img src="images/couple.jpg" alt="Sayali and Pranav">
